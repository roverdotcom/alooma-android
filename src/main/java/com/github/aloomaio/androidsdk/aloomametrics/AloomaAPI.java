...
public class AloomaAPI {
    ...
    public interface People {
         ...
         *
         * @see com.github.aloomaio.androidsdk.aloomametrics.GCMReceiver
         ...
         *
         * @param notif the {@link com.github.aloomaio.androidsdk.aloomametrics.InAppNotification} to show
         *
         * @param parent the Activity that the mini notification will be displayed in, or the Activity
         * that will be used to launch SurveyActivity for the takeover notification.
         */
         ...
         *
         * @param notif the {@link com.github.aloomaio.androidsdk.aloomametrics.InAppNotification} associated with the event you'd like to track.
         */
         ...
         * receive the same {@link com.github.aloomaio.androidsdk.aloomametrics.InAppNotification} again the
        ...
        /**
         * Tells MixPanel that you have handled an {@link com.github.aloomaio.androidsdk.aloomametrics.InAppNotification}
