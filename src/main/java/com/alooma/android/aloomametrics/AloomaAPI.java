...
import com.alooma.android.R;
import com.alooma.android.viewcrawler.UpdatesFromMixpanel;
import com.alooma.android.viewcrawler.TrackingDebug;
import com.alooma.android.viewcrawler.ViewCrawler;
import com.alooma.android.surveys.SurveyActivity;
import com.alooma.android.util.ActivityImageUtils;
...
public class AloomaAPI {
     ...
     * <pre>
     * {@code
     * AloomaAPI instance = AloomaAPI.getInstance(context, aloomaHost);
     ...
     *
     * @param context The application context you are tracking
     * @param token Your alooma token. You can get your project token on the Mixpanel web site,
     ...
     *
     * @deprecated in 4.0.0, use com.alooma.android.AConfig.FlushInterval application metadata instead
     */
    @Deprecated
     ...
     *
     * @deprecated in 4.0.0, use com.alooma.android.AConfig.EventsFallbackEndpoint, com.alooma.android.AConfig.PeopleFallbackEndpoint, or com.alooma.android.AConfig.DecideFallbackEndpoint instead
     */
    @Deprecated
    public static void enableFallbackServer(Context context, boolean enableIfTrue) {
        Log.i(
            LOGTAG,
            "AloomaAPI.enableFallbackServer is deprecated. This call is a no-op.\n" +
            "    To enable fallback in your application, add\n" +
            "    <meta-data android:name=\"com.alooma.android.AConfig.DisableFallback\" android:value=\"false\" />\n" +
            "    to the <application> section of your AndroidManifest.xml."
        );
    }
    ...
    // notifications from the UI thread, which might not be our AloomaAPI "home" thread.
     ...
     * You can get an instance by calling {@link AloomaAPI#getPeople()}
     *
    ...
    public interface People {
         ...
         *     and {@link AloomaAPI#identify(String)}
         *
         * @see AloomaAPI#identify(String)
         */
        public void identify(String distinctId);
         ...
         * <pre>
         * {@code
         * <receiver android:name="com.alooma.android.mpmetrics.GCMReceiver"
         ...
         *
         * @see com.alooma.android.aloomametrics.GCMReceiver
         * @see <a href="https://alooma.com/docs/people-analytics/android-push">Getting Started with Android Push Notifications</a>
         */
         ...
         *
         * <p>The id returned by getDistinctId is independent of the distinct id used to identify
         * any events sent with {@link AloomaAPI#track(String, JSONObject)}. To read and write that identifier,
         * use {@link AloomaAPI#identify(String)} and {@link AloomaAPI#getDistinctId()}.
         *
         * @return The distinct id associated with updates to People Analytics
         *
         * @see People#identify(String)
         * @see AloomaAPI#getDistinctId()
         */
        public String getDistinctId();
         ...
         *
         * @param notif the {@link com.alooma.android.aloomametrics.InAppNotification} to show
         *
         * @param parent the Activity that the mini notification will be displayed in, or the Activity
         * that will be used to launch SurveyActivity for the takeover notification.
         */
         ...
         *
         * @param notif the {@link com.alooma.android.aloomametrics.InAppNotification} associated with the event you'd like to track.
         */
         ...
         * receive the same {@link com.alooma.android.aloomametrics.InAppNotification} again the
        ...
        /**
         * Tells MixPanel that you have handled an {@link com.alooma.android.aloomametrics.InAppNotification}
     ...
     * {@code
     * <meta-data android:name="com.alooma.android.AConfig.EnableDebugLogging" />
     * }
     *
    ...
    public void logPosts() {
        Log.i(
                ...
                "AloomaAPI.logPosts() is deprecated.\n" +
                        ...
                        "    <meta-data android:name=\"com.alooma.android.AConfig.EnableDebugLogging\" value=\"true\" />\n" +
                        "    to the <application> section of your AndroidManifest.xml."
        );
    }
     ...
     * com.alooma.android.AConfig.AutoShowMixpanelUpdates to false in your AndroidManifest.xml
     *
     * This function is automatically called when the library is initialized unless you explicitly
     * set com.alooma.android.AConfig.AutoShowMixpanelUpdates to false in your AndroidManifest.xml
     */
    @TargetApi(AConfig.UI_FEATURES_MIN_API)
    /* package */ void registerMixpanelActivityLifecycleCallbacks() {
        if (android.os.Build.VERSION.SDK_INT >= AConfig.UI_FEATURES_MIN_API &&
                mConfig.getAutoShowMixpanelUpdates()) {
            if (mContext.getApplicationContext() instanceof Application) {
                final Application app = (Application) mContext.getApplicationContext();
                app.registerActivityLifecycleCallbacks((new AloomaActivityLifecycleCallbacks(this)));
            } else {
    ...
    /* package */ UpdatesListener constructUpdatesListener() {
        if (Build.VERSION.SDK_INT < AConfig.UI_FEATURES_MIN_API) {
    ...
    private class PeopleImpl implements People {
        ...
        public void checkForSurvey(final SurveyCallbacks callbacks) {
            Log.i(
                    LOGTAG,
                    "AloomaAPI.checkForSurvey is deprecated. Calling is now a no-op.\n" +
                     "    to query surveys, call AloomaAPI.getPeople().getSurveyIfAvailable()"
            );
        }
        ...
        public void trackNotificationSeen(InAppNotification notif) {
            ...
            final AloomaAPI.People people = getPeople().withIdentity(getDistinctId());
        ...
        public void initPushHandling(String senderID) {
            if (! ConfigurationChecker.checkPushConfiguration(mContext) ) {
                ...
                if (pushId == null) {
                    ...
                    AloomaAPI.allInstances(new InstanceProcessor() {
                        @Override
        ...
        private void registerForPushIdAPI19AndOlder(String senderID) {
            try {
                if (AConfig.DEBUG) Log.v(LOGTAG, "Registering a new push id");
    ...
    private static void registerAppLinksListeners(Context context, final AloomaAPI mixpanel) {
        // Register a BroadcastReceiver to receive com.parse.bolts.measurement_event and track a call to alooma
        try {
