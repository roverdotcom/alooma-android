...
/**
 * SQLite database adapter for AloomaAPI.
 *
...
/* package */ class MPDbAdapter {
    ...
    private static class MPDatabaseHelper extends SQLiteOpenHelper {
        MPDatabaseHelper(Context context, String dbName) {
            ...
            mConfig = ALConfig.getInstance(context);
        }
        ...
        public void onCreate(SQLiteDatabase db) {
            ALLog.v(LOGTAG, "Creating a new Alooma events DB");
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ALLog.v(LOGTAG, "Upgrading app, replacing Alooma events DB");
    ...
    public int addJSON(JSONObject j, String token, Table table, boolean isAutomaticRecord) {
        ...
        if (!this.belowMemThreshold()) {
            ALLog.e(LOGTAG, "There is not enough space left on the device to store Alooma data, so data was discarded");
        ...
        try {
            ...
            ALLog.e(LOGTAG, "Could not add Alooma data to table " + tableName + ". Re-initializing database.", e);
    ...
    public void cleanupEvents(String last_id, Table table, String token, boolean includeAutomaticEvents) {
        ...
        try {
            ...
            ALLog.e(LOGTAG, "Could not clean sent Alooma records from " + tableName + ". Re-initializing database.", e);
    ...
    public void cleanupEvents(long time, Table table) {
        ...
        try {
            ...
            ALLog.e(LOGTAG, "Could not clean timed-out Alooma records from " + tableName + ". Re-initializing database.", e);
    ...
    private void cleanupAutomaticEvents(Table table, String token) {
        ...
        try {
            ...
            ALLog.e(LOGTAG, "Could not clean automatic Alooma records from " + tableName + ". Re-initializing database.", e);
    ...
    /**
     * Returns the data string to send to Alooma and the maximum ID of the row that
    ...
    public String[] generateDataString(Table table, String token, boolean includeAutomaticEvents) {
        ...
        try {
            ...
            ALLog.e(LOGTAG, "Could not pull records for Alooma out of database " + tableName + ". Waiting to send.", e);
