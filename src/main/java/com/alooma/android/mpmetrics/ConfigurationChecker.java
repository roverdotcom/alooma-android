 ...
 *
 * This file has been modified from its original version by Alooma, Inc. The original
...
/* package */ class ConfigurationChecker {
    ...
    public static boolean checkBasicConfiguration(Context context) {
        ...
        if (packageManager == null || packageName == null) {
            ALLog.w(LOGTAG, "Can't check configuration when using a Context with null packageManager or packageName");
            return false;
        }
        if (PackageManager.PERMISSION_GRANTED != packageManager.checkPermission("android.permission.INTERNET", packageName)) {
            ALLog.w(LOGTAG, "Package does not have permission android.permission.INTERNET - Alooma will not work at all!");
            ALLog.i(LOGTAG, "You can fix this by adding the following to your AndroidManifest.xml file:\n" +
