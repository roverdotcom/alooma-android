...
/* package */ class AloomaActivityLifecycleCallbacks implements Application.ActivityLifecycleCallbacks {
    ...
    public AloomaActivityLifecycleCallbacks(AloomaAPI mpInstance, ALConfig config) {
    ...
    private final AloomaAPI mMpInstance;
