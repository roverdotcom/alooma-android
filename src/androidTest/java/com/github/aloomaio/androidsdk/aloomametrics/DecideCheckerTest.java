...
public class DecideCheckerTest extends AndroidTestCase {
    ...
    public void testReadSurvey1() {
        ...
        mPoster.response = bytes(
            "{\"surveys\":[ {" +
                    ...
                    "   \"collections\":[{\"selector\":\"\\\"@alooma\\\" in properties[\\\"$email\\\"]\",\"id\":141}]}" +
                    "]}"
        );
    ...
    public void testReadSurvey2() {
        mDecideChecker.addDecideCheck(mDecideMessages1);
        mPoster.response = bytes(
                "{\"surveys\":[{\"collections\":[{\"id\":151,\"selector\":\"\\\"@alooma\\\" in properties[\\\"$email\\\"]\"}],\"id\":299,\"questions\":[{\"prompt\":\"PROMPT1\",\"extra_data\":{\"$choices\":[\"Answer1,1\",\"Answer1,2\",\"Answer1,3\"]},\"type\":\"multiple_choice\",\"id\":287},{\"prompt\":\"How has the demo affected you?\",\"extra_data\":{\"$choices\":[\"I laughed, I cried, it was better than \\\"Cats\\\"\",\"I want to see it again, and again, and again.\"]},\"type\":\"multiple_choice\",\"id\":289}]}]}"
        );
    ...
    public void testBadDecideResponses() {
        ...
        mPoster.response = bytes(
            "{\"surveys\":[{\"collections\":[{\"id\":151,\"selector\":\"\\\"@alooma\\\" in properties[\\\"$email\\\"]\"}],\"id\":299,\"questions\":[]}]}"
        );
        mDecideChecker.runDecideChecks(mPoster);
        assertNull(mDecideMessages1.getSurvey(false));
        assertNull(mDecideMessages1.getNotification(false));
        ...
        mPoster.response = bytes(
            "{\"surveys\":[{\"id\":291,\"collections\":[{\"selector\":\"\\\"@alooma\\\" in properties[\\\"$email\\\"]\",\"id\":141}],\"questions\":[{\"id\":275,\"type\":\"multiple_choice\",\"extra_data\":{\"$choices\":[]},\"prompt\":\"Multiple Choice Prompt\"}]}]}"
        );
        mDecideChecker.runDecideChecks(mPoster);
        assertNull(mDecideMessages1.getSurvey(false));
        assertNull(mDecideMessages1.getNotification(false));
    ...
    public void testDecideResponses() throws DecideChecker.UnintelligibleMessageException {
        ...
        {
            final String notificationOnly = "{\"notifications\":[{\"body\":\"Hook me up, yo!\",\"title\":\"Tranya?\",\"message_id\":1781,\"image_url\":\"http://alooma.com/Balok.jpg\",\"cta\":\"I'm Down!\",\"cta_url\":\"http://www.alooma.com\",\"id\":119911,\"type\":\"takeover\"}]}";
            ...
            assertEquals(parsed.getImageUrl(), "http://alooma.com/Balok.jpg");
            assertEquals(parsed.getCallToAction(), "I'm Down!");
            assertEquals(parsed.getCallToActionUrl(), "http://www.alooma.com");
        ...
        {
            final String both = "{\"notifications\":[{\"body\":\"Hook me up, yo!\",\"title\":\"Tranya?\",\"message_id\":1781,\"image_url\":\"http://alooma.com/Balok.jpg\",\"cta\":\"I'm Down!\",\"cta_url\":\"http://www.alooma.com\",\"id\":119911,\"type\":\"mini\"}],\"surveys\":[{\"collections\":[{\"id\":3319,\"name\":\"All users 2\"},{\"id\":3329,\"name\":\"all 2\"}],\"id\":397,\"questions\":[{\"prompt\":\"prompt text\",\"extra_data\":{},\"type\":\"text\",\"id\":457}],\"name\":\"Demo survey\"}]}";
            ...
            assertEquals(parsedNotification.getImageUrl(), "http://alooma.com/Balok.jpg");
            assertEquals(parsedNotification.getCallToAction(), "I'm Down!");
            assertEquals(parsedNotification.getCallToActionUrl(), "http://www.alooma.com");
    ...
    private static class MockConfig extends AConfig {
