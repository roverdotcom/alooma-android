...
public class DecideFunctionalTest extends AndroidTestCase {
    ...
    public void setUp() throws InterruptedException {
        ...
        mMockConfig = new AConfig(new Bundle()) {
            @Override
        ...
        mMockMessages = new AnalyticsMessages(getContext()) {
            ...
            @Override
            protected AConfig getConfig(Context context) { return mMockConfig; }
        };
    }
    ...
    public void testDecideChecks() {
        ...
        mExpectations.expect(
            "https://decide.alooma.com/decide?version=1&lib=android&token=TEST+TOKEN+testSurveyChecks&distinct_id=DECIDE+CHECKS+ID+1",
             "{" +
                  "\"notifications\":[{\"body\":\"Hook me up, yo!\",\"title\":\"Tranya?\",\"message_id\":1781,\"image_url\":\"http://alooma.com/Balok.jpg\",\"cta\":\"I'm Down!\",\"cta_url\":\"http://www.alooma.com\",\"id\":119911,\"type\":\"mini\"}]," +
        ...
        mExpectations.expect(
            "https://decide.alooma.com/decide?version=1&lib=android&token=TEST+TOKEN+testSurveyChecks&distinct_id=DECIDE+CHECKS+ID+1",
            "{" +
                    "\"notifications\":[{\"body\":\"b\",\"title\":\"t\",\"message_id\":1111,\"image_url\":\"http://alooma.com/Balok.jpg\",\"cta\":\"c1\",\"cta_url\":\"http://www.alooma.com\",\"id\":3333,\"type\":\"mini\"}]," +
        ...
        mExpectations.expect(
            "https://decide.alooma.com/decide?version=1&lib=android&token=TEST+TOKEN+testSurveyChecks&distinct_id=DECIDE+CHECKS+ID+2",
            "{" +
                    "\"notifications\":[{\"body\":\"b\",\"title\":\"t\",\"message_id\":1111,\"image_url\":\"http://alooma.com/Balok.jpg\",\"cta\":\"c1\",\"cta_url\":\"http://www.alooma.com\",\"id\":3333,\"type\":\"mini\"}]," +
                    "\"surveys\":[{\"collections\":[{\"id\":3319,\"name\":\"n\"}],\"id\":8888,\"questions\":[{\"prompt\":\"p\",\"extra_data\":{},\"type\":\"text\",\"id\":457}],\"name\":\"N2\"}]," +
                    "\"event_bindings\": [{\"event_name\":\"EVENT NAME\",\"path\":[{\"index\":0,\"view_class\":\"com.android.internal.policy.impl.PhoneWindow.DecorView\"},{\"index\":0,\"view_class\":\"com.android.internal.widget.ActionBarOverlayLayout\"},{\"index\":0,\"view_class\":\"com.android.internal.widget.ActionBarContainer\"}],\"target_activity\":\"ACTIVITY\",\"event_type\":\"EVENT TYPE\"}]" +
    ...
    public void testDecideChecksOnConstruction() {
        ...
        final String prefsName = "com.alooma.android.mpmetrics.MixpanelAPI_" + useToken;
        ...
        mExpectations.expect(
            "https://decide.alooma.com/decide?version=1&lib=android&token=TEST+IDENTIFIED+ON+CONSTRUCTION&distinct_id=Present+Before+Construction",
            "{" +
                    "\"notifications\":[{\"body\":\"b\",\"title\":\"t\",\"message_id\":1111,\"image_url\":\"http://alooma.com/Balok.jpg\",\"cta\":\"c1\",\"cta_url\":\"http://www.alooma.com\",\"id\":3333,\"type\":\"mini\"}]," +
                    "\"surveys\":[{\"collections\":[{\"id\":3319,\"name\":\"n\"}],\"id\":8888,\"questions\":[{\"prompt\":\"p\",\"extra_data\":{},\"type\":\"text\",\"id\":457}],\"name\":\"N2\"}]," +
                    "\"event_bindings\": [{\"event_name\":\"EVENT NAME\",\"path\":[{\"index\":0,\"view_class\":\"com.android.internal.policy.impl.PhoneWindow.DecorView\"},{\"index\":0,\"view_class\":\"com.android.internal.widget.ActionBarOverlayLayout\"},{\"index\":0,\"view_class\":\"com.android.internal.widget.ActionBarContainer\"}],\"target_activity\":\"ACTIVITY\",\"event_type\":\"EVENT TYPE\"}]" +
            ...
            while (true) {
                try {
                    synchronized (this) {
                        if (mResultsFound) {
                            if (resultsBad) {
                                fail("Unexpected URL " + badUrl + " in AloomaAPI (expected " + mExpectUrl + ")\n" +
