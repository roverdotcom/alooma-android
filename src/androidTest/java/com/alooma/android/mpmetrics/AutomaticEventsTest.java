...
public class AutomaticEventsTest extends AndroidTestCase {
    ...
    private AloomaAPI mCleanAloomaAPI;
    ...
    protected void setUp() throws Exception {
        ...
        getContext().deleteDatabase("alooma");
    ...
    public void testAutomaticOneInstance() throws InterruptedException {
        ...
        mCleanAloomaAPI.track("An event One");
        mCleanAloomaAPI.flush();
    ...
    public void testDisableAutomaticEvents() throws InterruptedException {
        ...
        mLatch = new CountDownLatch(calls);
        mCleanAloomaAPI.track("An Event Three");
        assertTrue(mLatch.await(MAX_TIMEOUT_POLL, TimeUnit.MILLISECONDS));
        assertEquals(calls, mTrackedEvents);

        mCanRunDecide = true;
        mCleanAloomaAPI.track("Automatic Event Two", null, true); // dropped
        mCleanAloomaAPI.track("Automatic Event Three", null, true); // dropped
        mCleanAloomaAPI.track("Automatic Event Four", null, true); // dropped
        mCleanAloomaAPI.flush();
    ...
    public void testAutomaticMultipleInstances() throws InterruptedException {
        ...
        Thread.sleep(500);
        for (int i = 0; i < ALConfig.getInstance(getContext()).getBulkUploadLimit() - initialCalls; i++) {
            mCleanAloomaAPI.track("Track event " + i);
        }
        ...
        mCleanAloomaAPI.track("First Instance Event One");
